...
@DatamartRef(id = "custom_rozn_evo.da_prdct_rslt_salt_mnth_hdp", name = "Ref da_prdct_rslt_salt_mnth_hdp", useSystemPropertyToGetId = true)
@PartialReplace(partitioning = "report_dt", saveRemover = UpdatedPartitionRemover.class)
public class EvoPrdctRsltSaltMnth extends Datamart {

    private static final Logger log = LoggerFactory.getLogger(EvoPrdctRsltSaltMnth.class);
    ...
    public Dataset<Row> buildDatamart() {
        ...
        SparkSession spark = SparkSession
                .builder()
                .appName("greenplum_stg_prdct_rslt_salt_mnth_hdp")
                .enableHiveSupport()
                .getOrCreate();
        ...
        Dataset<Row> sourceTable = spark.read().format("io.pivotal.greenplum.spark.GreenplumRelationProvider")
                ...
                .option("dbtable", "da_prdct_rslt_salt_mnth_hdp")
                .option("url", gpurl)
                .option("user", user)
        ...
        Dataset<Row> result = sourceTable
                .select(
                        ...
                        col("salt").cast(StringType).as("salt")
    ...
    public static void main(String[] args) {
        runner().run(EvoPrdctRsltSaltMnth.class);
    }
}