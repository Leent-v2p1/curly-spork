...
@DatamartRef(id = "custom_rb_bo.v_ref_is0121_dic_security_list", name = "Ref Dic Security List", useSystemPropertyToGetId = true)
@FullReplace
public class DicSecurityList extends Datamart {

    private static final Logger log = LoggerFactory.getLogger(DicSecurityList.class);
    ...
    public Dataset<Row> buildDatamart() {
        ...
        SparkSession spark = SparkSession
                .builder()
                .appName("greenplum_stg_ref_is0121_dic_security_list")
                .enableHiveSupport()
                .getOrCreate();
        ...
        Dataset<Row> dicAgreement = spark.read().format("io.pivotal.greenplum.spark.GreenplumRelationProvider")
                ...
                .option("dbtable", "v_ref_is0121_dic_security_list")
                .option("url", gpurl)
                .option("user", user)
    ...
    public static void main(String[] args) {
        runner().run(DicSecurityList.class);
    }
}
