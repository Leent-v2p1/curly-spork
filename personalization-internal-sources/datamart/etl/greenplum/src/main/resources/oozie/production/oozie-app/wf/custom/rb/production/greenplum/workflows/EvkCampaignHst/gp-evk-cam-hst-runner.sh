source gp-evk-cam-hst-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.EVK.EvkCampaignHist \
    --properties-file gp-evk-cam-hst-properties-system.conf \
