source gp-bjd-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.BoJeDetails \
    --properties-file gp-bjd-properties-system.conf \
