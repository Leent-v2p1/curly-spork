source gp-ecosys-txn-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.Ecosys.FtEcosysTxnDet \
    --properties-file gp-ecosys-txn-properties-system.conf \
