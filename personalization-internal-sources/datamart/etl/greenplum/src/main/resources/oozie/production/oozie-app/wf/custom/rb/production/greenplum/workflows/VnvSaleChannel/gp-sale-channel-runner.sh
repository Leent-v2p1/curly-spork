source gp-sale-channel-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.VNV.VnvSaleChannel \
    --properties-file gp-sale-channel-properties-system.conf \
