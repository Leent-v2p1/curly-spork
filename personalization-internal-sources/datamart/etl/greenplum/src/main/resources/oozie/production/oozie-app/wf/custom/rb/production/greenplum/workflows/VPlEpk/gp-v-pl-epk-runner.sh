source gp-v-pl-epk-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.VPlEpk \
    --properties-file gp-v-pl-epk-properties-system.conf \
