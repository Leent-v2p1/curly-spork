source gp-product-sales-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.VNV.VnvProductSales \
    --properties-file gp-product-sales-properties-system.conf \
