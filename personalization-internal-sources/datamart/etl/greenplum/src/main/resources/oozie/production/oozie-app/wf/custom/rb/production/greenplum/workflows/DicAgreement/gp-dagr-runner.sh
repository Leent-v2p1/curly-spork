source gp-dagr-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.DicAgreement \
    --properties-file gp-dagr-properties-system.conf \
