source gp-evk-cam-dic-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.EVK.EvkCampaignDic \
    --properties-file gp-evk-cam-dic-properties-system.conf \
