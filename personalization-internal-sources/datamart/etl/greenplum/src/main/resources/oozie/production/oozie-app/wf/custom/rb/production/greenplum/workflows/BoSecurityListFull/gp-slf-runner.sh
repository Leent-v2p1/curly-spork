source gp-slf-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.SecurityListFull \
    --properties-file gp-slf-properties-system.conf \
