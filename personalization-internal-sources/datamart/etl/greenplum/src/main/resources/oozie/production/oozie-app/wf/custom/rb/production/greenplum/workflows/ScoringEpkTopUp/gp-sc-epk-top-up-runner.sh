source gp-sc-epk-top-up-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.Scoring.EpkTopUp \
    --properties-file gp-sc-epk-top-up-properties-system.conf \
