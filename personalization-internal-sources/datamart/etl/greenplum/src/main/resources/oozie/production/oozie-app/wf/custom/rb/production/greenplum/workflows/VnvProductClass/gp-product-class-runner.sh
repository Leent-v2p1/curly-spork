source gp-product-class-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.VNV.VnvProductClass \
    --properties-file gp-product-class-properties-system.conf \
