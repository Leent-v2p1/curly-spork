source gp-depfin-blu-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.DepFin.BillingLocalUfo \
    --properties-file gp-depfin-blu-properties-system.conf \
