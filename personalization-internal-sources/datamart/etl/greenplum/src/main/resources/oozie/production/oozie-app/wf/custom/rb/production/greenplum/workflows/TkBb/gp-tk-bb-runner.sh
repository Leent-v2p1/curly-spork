source gp-tk-bb-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.Scoring.TkBb \
    --properties-file gp-tk-bb-properties-system.conf \
