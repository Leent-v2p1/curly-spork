source gp-evk-cam-ch-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.EVK.EvkCampaignChannel \
    --properties-file gp-evk-cam-ch-properties-system.conf \
