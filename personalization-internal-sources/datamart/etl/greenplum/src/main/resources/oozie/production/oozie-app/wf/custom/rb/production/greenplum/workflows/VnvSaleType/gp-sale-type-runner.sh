source gp-sale-type-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.VNV.VnvSaleType \
    --properties-file gp-sale-type-properties-system.conf \
