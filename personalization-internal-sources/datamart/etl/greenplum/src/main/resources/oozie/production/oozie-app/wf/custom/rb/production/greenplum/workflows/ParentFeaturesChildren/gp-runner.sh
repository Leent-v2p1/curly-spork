source gp-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.ChildParents.ParentFeaturesChildren \
    --properties-file gp-properties-system.conf \
