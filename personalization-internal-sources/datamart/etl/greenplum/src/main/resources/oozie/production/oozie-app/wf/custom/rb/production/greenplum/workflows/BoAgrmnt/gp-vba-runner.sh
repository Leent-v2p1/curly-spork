source gp-vba-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.BoAgrmnt \
    --properties-file gp-vba-properties-system.conf \
