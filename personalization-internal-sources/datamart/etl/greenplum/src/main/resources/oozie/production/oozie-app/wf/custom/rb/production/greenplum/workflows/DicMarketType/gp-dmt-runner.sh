source gp-dmt-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.DicMarketType \
    --properties-file gp-dmt-properties-system.conf \
