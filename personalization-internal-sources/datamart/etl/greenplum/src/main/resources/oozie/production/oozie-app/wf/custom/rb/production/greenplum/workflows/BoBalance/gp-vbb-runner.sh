source gp-vbb-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.BoBalance \
    --properties-file gp-vbb-properties-system.conf \
