source gp-bjb-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.BoJeBalance \
    --properties-file gp-bjb-properties-system.conf \
