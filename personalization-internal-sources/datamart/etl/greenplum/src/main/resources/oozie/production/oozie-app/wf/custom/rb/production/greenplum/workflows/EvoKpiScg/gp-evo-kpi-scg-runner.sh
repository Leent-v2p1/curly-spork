source gp-evo-kpi-scg-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.EVO.EvoKpiScg \
    --properties-file gp-evo-kpi-scg-properties-system.conf \
