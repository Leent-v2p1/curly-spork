source gp-dsl-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.BO.DicSecurityList \
    --properties-file gp-dsl-properties-system.conf \
