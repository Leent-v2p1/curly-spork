source gp-ech-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.EVK.EvkCampaignHist1 \
    --properties-file gp-ech-properties-system.conf \
