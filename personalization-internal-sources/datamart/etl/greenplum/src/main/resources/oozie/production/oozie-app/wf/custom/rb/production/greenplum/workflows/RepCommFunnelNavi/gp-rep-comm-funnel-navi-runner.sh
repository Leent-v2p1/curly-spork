source gp-rep-comm-funnel-navi-properties-spark.conf
...
spark-submit \
    --class ru.sberbank.bigdata.cloud.rb.internal.sources.datamart.greenplum.EVO.RepCommFunnelNavi \
    --properties-file gp-rep-comm-funnel-navi-properties-system.conf \
