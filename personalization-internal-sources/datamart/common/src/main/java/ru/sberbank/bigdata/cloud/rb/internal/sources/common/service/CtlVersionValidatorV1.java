...
public class CtlVersionValidatorV1 {

    private static final Logger log = LoggerFactory.getLogger(CtlVersionValidatorV1.class);
    private static final String NO_DIGITS_AND_POINTS = "[^\\d.]*"; // все символы кроме цифр и '.'
    private CtlApiCalls ctlApiCalls;

    public CtlVersionValidatorV1(CtlApiCalls ctlApiCalls) {
    ...
    public static void main(String[] args) throws JSONException, IOException {
        ...
        CtlVersionValidatorV1 validator = new CtlVersionValidatorV1(ctlApiCalls);
    ...
    String getCtlVersion() throws JSONException, IOException {
