package ru.sberbank.bigdata.cloud.rb.internal.sources.generator.impl.production;
...
public class ProductionBuilder {
    public static void build() throws IOException {
        ...
        final String baseAppPath = "oozie-app/wf/custom/rb/production";
        ...
        FileUtils.copyDirectory(buildProperties.projectBuildDirectory.resolve("temp-production-workflows"), buildProperties.projectBuildDirectory);

        FileUtils.copyDirectory(buildProperties.projectBaseDir.resolve("src/main/resources/oozie"), buildProperties.projectBuildDirectory.resolve("oozie"));
